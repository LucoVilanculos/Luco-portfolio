        ...
        <footer className="bg-zinc-900 text-white py-8 px-4 md:px-6 ">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
                <div className="space-y-3">
                    <h2 className="text-lg font-semibold text-green-100">Luco Vilanculos</h2>
                    <p className="text-green-100">
                        Junior Full-Stack Developer apaixonado por transformar ideias em código limpo, leve e funcional.
                    </p>
                </div>
                ...
                <div className="space-y-3">
                    ...
                    <ul className="flex gap-4 text-green-100">
                        ...
                        <li>
                            <a
                                href="https://github.com/teu-usuario"
            ...
            <div className="text-center text-sm text-green-100">
                &copy; {currentYear} Luco Vilanculos. Todos os direitos reservados.
            </div>
        </footer>
    );
};
